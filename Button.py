...
class Button(object):
    def __init__(self, text: str, pos: tuple[int, int], size: tuple[int, int], a_color: tuple[int, int, int], ia_color: tuple[int, int, int], text_color: tuple[int, int, int], command, screen: pygame.Surface, font_size: int, exit_button_margin=None, ):
        self.text = text
        self.size = size
